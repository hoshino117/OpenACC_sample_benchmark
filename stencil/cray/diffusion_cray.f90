...
!CUDA
    ...
    print "(A, I4, A, F10.5, A, F10.5, A, F10.5, A, E12.5, A, I3, A, I3)", "opt thread block,", 256, ",", elapsed_time, ",", gflops, ",", thput, ",", err, ",", 128, "," ,1
...
!$acc end data
    ...
    print "(A, I4, A, F10.5, A, F10.5, A, F10.5, A, E12.5, A, I3, A, I3)", "loop interchange,", 256, ",", elapsed_time, ",", gflops, ",", thput, ",", err, ",", 128, "," ,1
...
!CUDA
    ...
    print "(A, I4, A, F10.5, A, F10.5, A, F10.5, A, E12.5, A, I3, A, I3)", "branch hoisting,", 256, ",", elapsed_time, ",", gflops, ",", thput, ",", err, ",", 128, "," ,1
...
!CUDA
    ...
    print "(A, I4, A, F10.5, A, F10.5, A, F10.5, A, E12.5, A, I3, A, I3)", "register blocking,", 256, ",", elapsed_time, ",", gflops, ",", thput, ",", err, ",", 128, "," ,1
